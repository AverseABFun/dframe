...
type Beep struct {
	tones      map[AudioID]beep.Streamer
	playing    map[AudioID]bool
	initalized bool
}
...
func (b *Beep) InitAudio() error {
	...
	b.tones = make(map[AudioID]beep.Streamer)
	b.playing = make(map[AudioID]bool)
	b.initalized = true
	return nil
}
...
func (b *Beep) PlayTone(freqHz float64) (AudioID, error) {
	b.InitAudio()
...
func (b *Beep) Playing(tone AudioID) bool {
	b.InitAudio()
...
func (b *Beep) PauseTone(tone AudioID) error {
	b.InitAudio()
...
func (b *Beep) ResumeTone(tone AudioID) error {
	b.InitAudio()
	b.playing[tone] = true
...
func (b *Beep) StopTone(tone AudioID) error {
	b.InitAudio()
	b.PauseTone(tone)
	delete(b.tones, tone)
