...
type PortAudio struct {
	tones   map[AudioID]*portaudio.Stream
...
func (pa *PortAudio) PlayTone(freqHz float64) (AudioID, error) {
...
func (pa *PortAudio) Playing(tone AudioID) bool {
...
func (pa *PortAudio) PauseTone(tone AudioID) error {
	pa.playing[tone] = false
	return pa.tones[tone].Stop()
}

func (pa *PortAudio) ResumeTone(tone AudioID) error {
	pa.playing[tone] = true
	return pa.tones[tone].Start()
}

func (pa *PortAudio) StopTone(tone AudioID) error {
